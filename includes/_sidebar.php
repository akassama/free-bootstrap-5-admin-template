    ...
    <div class="sidebar-section">
      ...
      <nav class="nav flex-column mb-2">
        ...
        <div class="collapse ps-4" id="pageExamplesMenu">
          ...
          <a href="#!" class="nav-link" target="_blank" id="nav-id-dropdown-2">
...
<script>
  ...
  (function setActiveNavLink() {
    ...
    if (navLink) {
      ...
      let parentCollapse = navLink.closest(".collapse");
      if (parentCollapse) {
        ...
        if (dropdownToggle) {
          ...
          if (typeof bootstrap !== "undefined" && bootstrap.Collapse) {
            let bsCollapse = new bootstrap.Collapse(parentCollapse, {
              toggle: false,
            });
            bsCollapse.show();
          } else {
